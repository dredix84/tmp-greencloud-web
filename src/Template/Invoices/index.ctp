        ...
        <div class="col-md-12">
            ...
            <section class="panel panel-info panel-search">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><?= __('Search'); ?> <?= __('Invoices') ?></h2>
                </header>
            ...
            <section class="panel panel-primary panel-data">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><?= __('Invoices') ?> <small>(<?= $count ?> <?= $count == 1 ? __('Record found') : __('Records found') ?> )</small></h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-md">
                                <?= $this->Html->link(__('Create Invoice <i class="fa fa-plus"></i>'), ['action' => 'add'], ['escape' => false, 'class' => 'btn btn-success modalbox', 'data-ajaxlink' => '#modalbox']) ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-hover mb-none">
                            <thead>
                                <tr>
                                    ...
                                    <th><?= $this->Paginator->sort('invoice_status_id') ?></th>
                                    <th><?= $this->Paginator->sort('merchant_id') ?></th>
                                    <th><?= $this->Paginator->sort('to_merchant_id') ?></th>
                                        ...
                                        <td class="actions">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><?= $this->Html->link(__('View'), ['action' => 'view', $invoice->id], ['escape' => false, 'class' => 'modalbox', 'data-ajaxlink' => '#modalbox']) ?></li>
                                                    <li><?= $this->Html->link(__('Edit'), ['action' => 'edit', $invoice->id], ['escape' => false, 'class' => 'modalbox', 'data-ajaxlink' => '#modalbox']) ?></li>
                                                    <li class="divider"></li>
                                                    <li><?= $this->Html->link(__('Delete'), ['action' => 'delete', $invoice->id], ['escape' => false, 'class' => 'ajaxrowdelete']) ?></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
