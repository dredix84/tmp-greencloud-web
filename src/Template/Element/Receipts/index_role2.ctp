        ...
        <div class="col-md-12">
            ...
            <section class="panel panel-primary">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><?= __('Receipts ') ?> <?= isset($userinfo['merchant']) ? ' for ' . $userinfo['merchant']['name'] : '' ?> <small>(<?= $count ?> <?= $count == 1 ? __('Record found') : __('Records found') ?> )</small></h2>
                </header>
                <div class="panel-body">
                            ...
                            <tbody>
                                <?php foreach ($receipts as $receipt): ?>
                                    <tr>
                                        ...
                                        <td data-title="<?= __('Credits Used') ?>"><?= $receipt->credits_used ?></td>
