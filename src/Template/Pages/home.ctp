...
<html>
    ...
    <body class="home">
        ...
        <?= __('Want to login?') ?> <?= $this->Html->link(__('Login here!'), ['controller' => 'Users', 'action' => 'login']); ?> <br />
        <?= $this->Html->link(__('My Receipts Dashboard'), ['controller' => 'Dashboards']); ?> <br />
        <header>
            <div class="header-image">
                <?= $this->Html->image('logo_1.png') ?>
                <h1>Your receipts, in the cloud.</h1>
            </div>
        </header>
        <?php /*
        <div id="content">
