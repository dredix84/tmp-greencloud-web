...
?>
<div class="autoActions index large-9 medium-8 columns content">
        ...
        <div class="col-md-12">
            ...
            <section class="panel panel-info panel-search">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><?= __('Search'); ?> <?= __('Auto Actions') ?></h2>
                </header>
            ...
            <section class="panel panel-primary panel-data">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><?= __('Auto Actions') ?> <small>(<?= $count ?> <?= $count == 1 ? __('Record found') : __('Records found') ?> )</small></h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-md">
                                <?= $this->Html->link(__('New Auto Action <i class="fa fa-plus"></i>'), ['action' => 'add'], ['escape' => false, 'class' => 'btn btn-success modalbox', 'data-ajaxlink' => '#modalbox']) ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-hover mb-none">
                            <thead>
                                <tr>
                                    ...
                                    <th><?= $this->Paginator->sort('row_count') ?></th>
                                    <th><?= $this->Paginator->sort('created') ?></th>
                                    <th class="actions"><?= __('Actions') ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($autoActions as $autoAction): ?>
                                    <tr>
                                        <td data-title='title' >
                                            <?= $this->Html->link(h($autoAction->title), ['action' => 'view', $autoAction->id], ['escape' => false, 'class' => 'modalbox', 'data-ajaxlink' => '#modalbox']) ?>
                                        </td>
                                        ...
                                        <td class="actions">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><?= $this->Html->link(__('View'), ['action' => 'view', $autoAction->id], ['escape' => false, 'class' => 'modalbox', 'data-ajaxlink' => '#modalbox']) ?></li>
                                                    <li><?= $this->Html->link(__('Edit'), ['action' => 'edit', $autoAction->id], ['escape' => false, 'class' => 'modalbox', 'data-ajaxlink' => '#modalbox']) ?></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
