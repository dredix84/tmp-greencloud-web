...
?>
<div class="receiptItems index large-9 medium-8 columns content">
        ...
        <div class="col-md-12">
            ...
            <section class="panel panel-info">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><?=__('Search'); ?> <?= __('Receipt Items') ?></h2>
                </header>
            ...
            <section class="panel panel-primary">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title"><?= __('Receipt Items') ?></h2>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-md">
                                <?= $this->Html->link(__('New Receipt Item <i class="fa fa-plus"></i>'), ['action' => 'add'], ['escape' => false, 'class'=>'btn btn-success modalbox', 'data-ajaxlink' => '#modalbox']) ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><?= $this->Html->link(__('View'), ['action' => 'view', $receiptItem->id], ['escape'=>false, 'class' => 'modalbox', 'data-ajaxlink' => '#modalbox']) ?></li>
                                                <li><?= $this->Html->link(__('Edit'), ['action' => 'edit', $receiptItem->id], ['escape'=>false, 'class' => 'modalbox', 'data-ajaxlink' => '#modalbox']) ?></li>
                                                <li class="divider"></li>
                                                <li><?= $this->Html->link(__('Delete'), ['action' => 'delete', $receiptItem->id], ['escape'=>false, 'class'=>'ajaxrowdelete']) ?></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
